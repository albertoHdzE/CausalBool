...
\begin{figure}[H]
    ...
    \caption{\textbf{Paired TCGA corruption under a frozen expression-to-network scaffold.} (Left) Distribution of paired $\Delta D^{(v2)}$ across $n=50$ patients (negative values indicate tumor networks are more compressible). (Right) Correlation between $\Delta D^{(v2)}$ and inferred perturbation\_count.}
\end{figure}
