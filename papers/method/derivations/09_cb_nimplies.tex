...
% Witness source: verification/NIMPLIES.json (executed Tue 25 Aug 2026 15:27:25)
\documentclass{article}
\usepackage{amsmath,amssymb}
\title{Gate family NIMPLIES: closed-form one-set derivation}
\date{2026-08-25}
\begin{document}
\maketitle

\paragraph{Definition.} $g(x)=x_{a}\wedge\neg x_{b}$.

\paragraph{Closed form.} $J=B_{a}\cap\overline{B}_{b}$ (the failure pattern of implication itself).

\paragraph{Ordering transport.} Same transport identity as IMPLIES without the outer complement.
