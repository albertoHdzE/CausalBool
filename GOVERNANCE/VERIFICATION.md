...
| Declared Python suite | **237** tests over **26** files (1 skipped, declared) | CI asserts the count; membership from `MANIFEST.tsv` |
| `src/` line+branch coverage | **29.31 %** over **61** files | `check_coverage_ratchet.py`, global + per-module floors |
...
| Test files classified | **121 / 121** — 85 Wolfram + 36 Python (98 test, 15 producer, 8 quarantine) | `check_test_manifest.sh` |
