...
| Declared Python suite | **223** tests over **25** files (1 skipped, declared) | CI asserts the count; membership from `MANIFEST.tsv` |
| `src/` line+branch coverage | **29.05 %** over **61** files | `check_coverage_ratchet.py`, global + per-module floors |
