...
| Declared Python suite | **266** tests over **28** files (1 skipped, declared) | CI asserts the count; membership from `MANIFEST.tsv` |
| `src/` line+branch coverage | **31.35 %** over **61** files | `check_coverage_ratchet.py`, global + per-module floors |
