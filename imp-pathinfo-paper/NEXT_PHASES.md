...
* **Training campaign**: 607 runs, 202 of 216 cases. Resume:
```bash
...
* Remaining gaps in the campaign: Graphormer on BBBP, ClinTox, Lipophilicity;
  Mix-Hop on Lipophilicity and part of ClinTox. None of the conclusions depend on
  them.
