...
Output: data/processed/cellnet_16ct/cellnet_landscape_data.csv
"""
import os
import sys
import time
...
def main():
    processed_dir = os.path.join(project_root, "data", "processed", "cellnet_16ct")
