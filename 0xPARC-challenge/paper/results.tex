...
\subsection*{Original direct arithmetic systems}
...
Q8 & 25725 & 25597\\
\bottomrule\end{tabular}\end{center}
\subsection*{CausalBool-assisted arithmetic systems}
\begin{center}\begin{tabular}{lrr}\toprule System & Rows & Signals\\\midrule
Q5 & 321 & 193\\
Q6 & 2499 & 1376\\
Q7 & 407 & 200\\
\bottomrule\end{tabular}\end{center}
The CausalBool verifier checks all 4096 width-four Q7 assignments, with 16 valid and 4080 invalid cases, against an independent integer predicate.
