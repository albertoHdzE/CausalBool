...
base = FileNameJoin[{"results", "tests", "tt001"}];
...
maxArity = 6; (* backward compatible default was 4; now extended *)
...
computeOne[{gate_, n_, params_}] := Module[{msbTruth, lsbTruth, lsbIdx, mappedIdx, msbIdx, okOrd},
  ...
  <|"gate" -> gate, "arity" -> n, "params" -> params, "okOrdering" -> okOrd, "MSBTruth" -> msbTruth, "LSBTruth" -> lsbTruth|>
];
