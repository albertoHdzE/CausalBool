\chapter{How meta-perturbation test works}
% -------------------------------
...
\begin{algorithm}[!htb]
    ...
    \ForEach{$s_i \in \Sumandos$}{%
        \ForEach{$r_i \in \Repertoire$}{%
            $\Append(\Indexes, \Sum(s_i, r_i))$\;
        }	
    }

    \caption{Computes Positions of a Pattern in Outputs}\label{algo_computesPositionsOfAPatternInOutputs}
    \end{minipage}
    }
\end{algorithm}
\DecMargin{1em}
