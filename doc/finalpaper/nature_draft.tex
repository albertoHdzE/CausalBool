...
\end{equation}
Across a validation set of 31 genes (including \textit{E. coli} and \textit{S. pombe}), $\Delta D$ successfully classified essential genes with **83.9\% accuracy** (AUC = 0.79). Essential genes exhibit a characteristic "Information Backbone" signature: their removal causes a disproportionate collapse in the system's algorithmic description, far exceeding the impact of non-essential hubs.
