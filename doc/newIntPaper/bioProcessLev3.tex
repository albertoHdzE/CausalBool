...
\title{Bio Process Level 3 \& 4: Universal D\_v2 Encoder Validation \& Clinical Integration}
\author{Complexity Science Group}
\date{\today}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/null_comparison.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/zscore_dist.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/phase_transition_bdm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/mechanistic_stability.png}
